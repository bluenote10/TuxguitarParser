...
public class MidiPlayer{
	 ...
	 * 
	 * FK: 
	 * MidiSequenceParser and MidiSequenceHandler are connected here, seams to be important
	 * As a result, the whole song should be converted to midi signals after this function call?
	 * This function is only called from this.play()
	 * The side effect of this functions is that the MidiSequenceHandler (from: getSequencer().createSequence(...)) will be filled (?) with midi events 
	 */
